...
for(ii in 1:klater){
  ...
  pvals.spike[ii] = poly.pval(y0,G,u=rep(0,nrow(G)),v=d.spike,sigma=sigma)$pv
  pvals.segment[ii] = poly.pval(y0,G,u=rep(0,nrow(G)),v=d.segment,sigma=sigma)$pv
...
## Collect the true jump-points's naive p-value distribution, and null
## jump-point's naive p-value distribution'
