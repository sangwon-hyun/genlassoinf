...
for(test.step in 1:f0$stoptime){
    ...
    d = get_v_1dfusedlasso(f0,y0,test.step,stoptime.bic,type="segment")

    ## TG p-value
    pvals[loc] = poly.pval(y=y0, G=G, u=u, v=d, sigma=sigma)$pv
...
## Optionally, create a step-sign plot to /manually/; see step-sign-demo.R
